...
#include "triton-shared/Dialect/Triton/Transforms/Passes.h"
...
static LLVM::DISubprogramFlags setSubprogramFlags(triton::FuncOp funcOp) {
...
class AddLLVMDebugInfoPass
    : public mlir::triton::impl::AddLLVMDebugInfoBase<AddLLVMDebugInfoPass> {
  using AddLLVMDebugInfoBase<AddLLVMDebugInfoPass>::AddLLVMDebugInfoBase;
