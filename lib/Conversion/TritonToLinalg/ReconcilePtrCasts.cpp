...
struct ToMemrefConverter : public OpRewritePattern<UnrealizedConversionCastOp> {
  ...
  LogicalResult matchAndRewrite(UnrealizedConversionCastOp op,
    ...
    if (isa<triton::PointerType, ptr::PtrType>(inType) &&
      ...
      auto ptrToMemref = rewriter.create<ptr::FromPtrOp>(
...
class ReconcilePtrCastsPass
    : public mlir::triton::impl::ReconcilePtrCastsBase<ReconcilePtrCastsPass> {
  using ReconcilePtrCastsBase<ReconcilePtrCastsPass>::ReconcilePtrCastsBase;
