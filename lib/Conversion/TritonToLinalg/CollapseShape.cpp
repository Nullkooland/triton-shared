...
struct CollapseBroadCast : public OpRewritePattern<linalg::GenericOp> {
  ...
  LogicalResult matchAndRewrite(linalg::GenericOp op,
    ...
    auto linalgOp = rewriter.create<linalg::GenericOp>(
        ...
        indexingMaps, triton::getNParallelLoopsAttrs(resultRank));
...
class CollapseShapePasss
    : public mlir::triton::impl::CollapseShapeBase<CollapseShapePasss> {
  using CollapseShapeBase<CollapseShapePasss>::CollapseShapeBase;
