...
class UnstructuredToMemrefPass
    : public mlir::triton::impl::UnstructuredToMemrefBase<
          UnstructuredToMemrefPass> {
  using UnstructuredToMemrefBase<
      UnstructuredToMemrefPass>::UnstructuredToMemrefBase;
